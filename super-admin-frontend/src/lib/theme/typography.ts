...
// High-contrast text color utilities
export const textColors = {
  ...
  accent: {
    light: '#2b6cb0',      // Blue for links
    dark: '#63b3ed',       // Light blue for dark backgrounds
  },
  
  // Status colors with high contrast
  success: {
    light: '#22543d',      // Dark green
    dark: '#68d391',       // Light green
  },
  
  warning: {
    light: '#744210',      // Dark orange
    dark: '#f6e05e',       // Light yellow
  },
  
  error: {
    light: '#742a2a',      // Dark red
    dark: '#fc8181',       // Light red
  },
  
  info: {
    light: '#2a4365',      // Dark blue
    dark: '#90cdf4',       // Light blue
  },
};
...
export const typographyClasses = {
  ...
  // Special emphasis for tenant names and important data
  tenantName: 'text-base font-semibold leading-normal tracking-wide',
