...
const ElectricBorder: React.FC<ElectricBorderProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          {/* Use large default filter region to avoid any clipping before runtime adjustments */}
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ ...inheritRadius, zIndex: 3, overflow: 'visible' }}>
        <div ref={strokeRef} className="absolute inset-0 box-border" style={{ ...strokeStyle, mixBlendMode: 'screen', willChange: 'filter' }} />
        <div className="absolute inset-0 box-border" style={{ ...glow1Style, mixBlendMode: 'screen' }} />
        <div className="absolute inset-0 box-border" style={{ ...glow2Style, mixBlendMode: 'screen' }} />
        <div className="absolute inset-0" style={{ ...bgGlowStyle, zIndex: 0 }} />
      </div>
