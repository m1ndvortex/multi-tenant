/**
 * Enhanced Card Component for Tenant Frontend
  ...
  "rounded-xl transition-all duration-300 border-0 shadow-lg hover:shadow-xl",
  {
    variants: {
      variant: {
        ...
        // Gradient background cards for tenant context (emerald theme)
        "gradient-primary": "bg-gradient-to-br from-emerald-50 via-white to-green-50 text-gray-900 border border-emerald-100",
        "gradient-secondary": "bg-gradient-to-br from-green-50 via-white to-teal-50 text-gray-900 border border-green-100",
        ...
        filter: "bg-gradient-to-r from-emerald-50 to-green-100 text-gray-900 border border-emerald-200 shadow-sm",
