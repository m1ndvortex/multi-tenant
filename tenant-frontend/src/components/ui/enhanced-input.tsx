/**
 * Enhanced Input Component for Tenant Frontend
...
const enhancedInputVariants = cva(
  "flex w-full rounded-lg border-2 bg-white px-4 py-3 text-sm font-medium transition-all duration-200 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "border-gray-300 text-gray-900 placeholder:text-gray-500 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-100 hover:border-gray-400",
        ...
        "high-contrast": "border-gray-900 text-black placeholder:text-gray-700 focus:border-emerald-800 focus:ring-2 focus:ring-emerald-200",
      },
      size: {
