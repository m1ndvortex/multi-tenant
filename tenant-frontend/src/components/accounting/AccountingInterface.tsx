...
import { Building2, BookOpen, FileText, Calculator } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-4 bg-gradient-to-r from-green-50 via-teal-50 to-blue-50 p-1 rounded-lg">
          <TabsTrigger 
