"""add_api_access_system_tables

Revision ID: 8d8ac3df4c7b
Revises: d104c6468599
Create Date: 2025-09-06 12:45:23.189485
...
revision = '8d8ac3df4c7b'
down_revision = 'd104c6468599'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column('invoices', 'branding_id',
               existing_type=sa.UUID(),
               comment='Invoice branding ID',
               existing_nullable=True)
    op.alter_column('invoices', 'numbering_scheme_id',
               existing_type=sa.UUID(),
...
def downgrade() -> None:
    ...
    op.alter_column('invoices', 'numbering_scheme_id',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='Numbering scheme ID',
               existing_nullable=True)
    op.alter_column('invoices', 'branding_id',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='Invoice branding ID',
               existing_nullable=True)
    op.alter_column('invoices', 'template_id',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='Invoice template ID',
               existing_nullable=True)
